        ...
        <Styled.OptionContainer>
          ...
          <Styled.Answer tab={tab} index={1}>
            <Text size="2.6rem">
              ...
              de aparelhos conectados à internet. Você pode assistir a quantos
              filmes e séries quiser, quando e onde quiser – tudo por um preço
              mensal acessível. Aqui você sempre encontra novidades. A cada
        ...
        <Styled.OptionContainer>
          ...
          <Styled.Answer tab={tab} index={4}>
            <Text size="2.6rem">
              ...
              streaming e videogames. Você também pode baixar a sua série
              favorita com o aplicativo Netflix para iOS, Android ou Windows 10.
              Use downloads para levar a Netflix para onde quiser sem precisar
              de conexão com a Internet. Leve a Netflix com você para qualquer
              lugar.
            </Text>
          </Styled.Answer>
        </Styled.OptionContainer>
        ...
        <Styled.OptionContainer>
          ...
          <Styled.Answer tab={tab} index={7}>
            <Text size="2.6rem">
              ...
              controle parental, incluso nos perfis para crianças e protegido
              por PIN, permite restringir a classificação etária do conteúdo que
              as crianças podem ver e bloquear títulos específicos que você não
