...
export const CardTopTen = ({
  ...
  const posterUrl = `${process.env.NEXT_PUBLIC_IMAGE_URL}${poster}`;
      ...
      <Styled.Modal>
        ...
        <Styled.DataContainer>
          ...
          <Styled.Controls>
            ...
            <button className="chevron-container" onClick={handleModalClick}>
              <ChevronDown size="20px" />
            </button>
            <Styled.Info>
              Mais Informações
              <ArrowDropDown size="40px" />
            </Styled.Info>
          </Styled.Controls>
          <Text>{score}</Text>
          <Styled.AgeRatingContainer>
            ...
            <Text size="1.3rem">Não recomendado para menores de 16 anos</Text>
          </Styled.AgeRatingContainer>
        </Styled.DataContainer>
      </Styled.Modal>
    </Styled.Wrapper>
